...
t = 1.4018, df = 92.409, p-value = 0.1643
alternative hypothesis: true difference in means is not equal to 0 
95 percent confidence interval:
 -0.1022537  0.5930060 
sample estimates:
mean in group 0 mean in group 1 
     0.08125403     -0.16412214
\end{verbatim}
...
\begin{verbatim}
                    x         y sex
     1 -0.3409091 19.949138   f
     2 -0.1316638 11.382895   m
     3 -0.2772535 16.608719   f
     4 -1.2859231  7.594134   m
\end{verbatim}
\end{frame}
...
\begin{verbatim}
                x                  y          sex  
      Min.   :-1.28592   Min.   : 3.272   f:5  
      1st Qu.:-0.25101   1st Qu.: 7.925   m:5  
      Median :-0.08269   Median :11.047        
      Mean   :-0.06424   Mean   :11.336        
      3rd Qu.: 0.19868   3rd Qu.:15.108        
      Max.   : 0.69569   Max.   :19.949
\end{verbatim}
...
\begin{verbatim}
     ...
     -1.28600 -0.25100 -0.08269 -0.06424  0.19870  0.69570
\end{verbatim}
\end{frame}
\begin{frame}[fragile]
