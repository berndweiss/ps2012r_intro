...
t = -0.2202, df = 81.968, p-value = 0.8263
...
\item \texttt{head(n})=: show first \texttt{n} cases
\end{itemize}
\end{frame}
...
\begin{verbatim}
                    x         y sex
     1  0.4193362 12.518774   f
     2 -0.6164952  9.229247   m
     3  0.4345107  7.928392   f
     4  0.9799077 11.600855   m
\end{verbatim}
\end{frame}
...
\begin{verbatim}
                x                  y          sex  
      Min.   :-1.33138   Min.   : 7.928   f:5  
      1st Qu.:-0.56148   1st Qu.: 9.749   m:5  
      Median :-0.09711   Median :10.785        
      Mean   :-0.14979   Mean   :12.131        
      3rd Qu.: 0.43072   3rd Qu.:13.229        
      Max.   : 0.97991   Max.   :18.844
\end{verbatim}
...
\begin{verbatim}
     ...
     -1.33100 -0.56150 -0.09711 -0.14980  0.43070  0.97990
\end{verbatim}
\end{frame}
\begin{frame}[fragile]
