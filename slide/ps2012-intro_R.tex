...
\label{sec-4-1-12}
    ...
    :BEAMER$_{\mathrm{envargs}}$: [shrink = 5 ]
...
\begin{verbatim}
                     x         y sex
     1 -0.24469828 15.949615   f
     2 -1.01184185  4.250786   m
     3 -0.65802345 10.657806   f
     4  0.05696325 12.178305   m
\end{verbatim}
\end{frame}
...
\begin{verbatim}
      x                 y         
Min.   :-1.4420   Min.   : 4.251  
1st Qu.:-0.9465   1st Qu.: 8.912  
Median :-0.4514   Median :11.908  
Mean   :-0.3476   Mean   :12.545  
3rd Qu.: 0.4668   3rd Qu.:15.980  
Max.   : 0.6562   Max.   :21.870  
sex  
f:5  
m:5
\end{verbatim}
...
\begin{verbatim}
     ...
     -1.4420 -0.9465 -0.4514 -0.3476  0.4668 
        Max. 
      0.6562
\end{verbatim}
\end{frame}
